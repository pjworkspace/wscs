 ...
 */
package com.xxx.market.web.core.plugin.shiro;
...
public class ShiroPlugin implements IPlugin {
	...
	private JdbcAuthzService jdbcAuthzService = Enhancer.enhance(JdbcAuthzService.class.getSimpleName(), MyJdbcAuthzService.class);
