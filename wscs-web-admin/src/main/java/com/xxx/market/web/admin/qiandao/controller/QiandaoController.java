package com.xxx.market.web.admin.qiandao.controller;
...
import com.xxx.market.service.api.qiandao.QiandaoResultDto;
	...
	public void list(){
		...
		for(Qiandao q : qiandaoPage.getList()){
			...
			if(getUsedAuthUser() !=null){
				qiandaoResultDto.setWirlessUrl("http://"+getUsedAuthUser().getAppId()+".xxx.com/qiandao/?qiandaoId="+q.getId());
			}
