...
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/layer/layer.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/toastr/toastr.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/sweetalert/sweetalert.min.js"></script>
    ...
    <div>
        ...
        <form class="m-t" role="form" action="index.html">
            <div class="form-group">
                <input id="username" name="username" value="admin" type="text" class="form-control" placeholder="账号" required=""/>
            </div>
            <div class="form-group">
