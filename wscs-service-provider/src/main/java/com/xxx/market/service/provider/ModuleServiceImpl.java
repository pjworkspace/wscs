...
import com.xxx.market.model.Module;
import com.xxx.market.model.ModuleFun;
...
public class ModuleServiceImpl implements ModuleService {
	...
	public FuncResultDto getModuleFun(GetFunParamDto funParamDto) throws ModuleException {
		...
		Module module = Module.dao.findById(funParamDto.getModuleId());
		...
		ModuleFun moduleFun = ModuleFun.dao.findFirst(
		...
		funcResultDto.setFuncUrl("http://"+funParamDto.getAuthAppId()+".xxx.com" + moduleFun.getFunUrl());
		funcResultDto.setQrcode(JFinal.me().getContextPath()+"/qrcode/genio?url="+"http://"+funParamDto.getAuthAppId()+".xxx.com" + moduleFun.getFunUrl());
