...
import com.xxx.market.model.ProductImage;
...
import com.xxx.market.service.api.product.ImagepathResultDto;
import com.xxx.market.service.api.product.ProductAllResultDto;
import com.xxx.market.service.api.product.ProductDetailResultDto;
import com.xxx.market.service.api.product.ProductException;
import com.xxx.market.service.api.product.ProductMobileParamDto;
import com.xxx.market.service.api.product.ProductMobileResultDto;
...
import com.xxx.market.service.api.product.ProductSpecPriceResultDto;
import com.xxx.market.service.api.product.ProductSubmitParamDto;
import com.xxx.market.service.api.serinum.SerinumService;
import com.xxx.market.service.api.specification.SpecificationResultDto;
...
public class ProductServiceImpl extends AbstractServiceImpl implements ProductService{
	...
	public ProductDetailResultDto getMobieDetail(ProductParamDto productParamDto) {
		...
		if(productParamDto.getAppId() != null){
			productDetail.setWirlessUrl("http://"+productParamDto.getAppId()+".xxx.com/product/detail?id="+product.getId());
		}
