...
import com.xxx.market.model.Lottery;
import com.xxx.market.model.LotteryAward;
import com.xxx.market.model.LotteryRecord;
import com.xxx.market.model.LotteryTrade;
import com.xxx.market.model.Prize;
import com.xxx.market.model.PrizeType;
import com.xxx.market.model.SellerUser;
import com.xxx.market.service.api.exception.MarketBaseException;
import com.xxx.market.service.api.lottery.DrawResultDto;
import com.xxx.market.service.api.lottery.LotteryResultDto;
import com.xxx.market.service.api.lottery.LotteryService;
import com.xxx.market.service.api.lottery.LotteryServiceException;
import com.xxx.market.service.api.lottery.LotteryTestResultDto;
import com.xxx.market.service.api.prize.PrizeSendParamDto;
import com.xxx.market.service.api.prize.PrizeService;
import com.xxx.market.service.constants.Constants;
import com.xxx.market.service.enmu.LotteryCondType;
import com.xxx.market.service.enmu.LotteryType;
import com.xxx.market.service.utils.DateTimeUtil;
import com.xxx.market.service.utils.StringUtils;
...
public class LotteryServiceImpl extends AbstractActivityService implements LotteryService{
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.lottery.LotteryService#save(com.xxx.market.model.Lottery)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.lottery.LotteryService#update(com.xxx.market.model.Lottery)
	 */
	@Override
	@Transactional(rollbackFor = LotteryServiceException.class)
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.lottery.LotteryService#list(int, int)
	 */
	@Override
	public Page<LotteryResultDto> list(int pageNo, int pageSize, Map<String, String> paramsMap) throws LotteryServiceException {
		...
		for(Lottery lottery : lotteryPage.getList()){
			...
			if(getUsedAuthUser(Long.valueOf(paramsMap.get("sellerId"))) != null){
				lvo.setWirlessUrl("http://"+getUsedAuthUser(Long.valueOf(paramsMap.get("sellerId"))).getAppId()+".xxx.com/lottery/draw/?lotteryId="+lottery.getId());
			}
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.api.lottery.LotteryService#lottery(com.xxx.market.model.Lottery, java.lang.Long, java.lang.Long)
	 */
	@Override
	@Transactional(rollbackFor = LotteryServiceException.class)
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.api.lottery.LotteryService#test(java.lang.Long)
	 */
	@Override
