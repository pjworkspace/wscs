...
import com.xxx.market.model.QiandaoRecord;
...
import com.xxx.market.service.api.prize.PrizeSendResultDto;
...
public class QiandaoServiceImpl extends AbstractActivityService implements QiandaoService{
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.qiandao.QiandaoService#doSave(com.xxx.market.model.Task, java.lang.String, com.xxx.market.model.SellerUser)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.qiandao.QiandaoService#doUpdate(com.xxx.market.model.Task, java.lang.String, com.xxx.market.model.SellerUser)
	 */
	@Override
	@Transactional(rollbackFor = QiandaoException.class)
	...
	/* (non-Javadoc)
	 * @see com.xxx.market.service.api.qiandao.QiandaoService#getCurrQiandao()
	 */
	@Override
