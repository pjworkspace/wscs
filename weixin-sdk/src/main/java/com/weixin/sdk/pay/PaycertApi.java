...
public abstract class PaycertApi extends PayApi{
	...
	public BaseResData post(BaseReq reqData) throws Exception {
        ...
        String postDataXML = getRequestXml(reqData.toMap());
...
//        InputStream instream = getClass().getClassLoader().getResourceAsStream(Constants.certLocalPath);
        ...
        try {
            keyStore.load(instream, WxSdkPropKit.get("wx_mch_id").toCharArray());//设置证书密码
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, WxSdkPropKit.get("wx_mch_id").toCharArray())
                .build();
