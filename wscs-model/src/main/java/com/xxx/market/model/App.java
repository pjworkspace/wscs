...
public class App {
	public static void main( String[] args ) {
    	...
    	// base model 所使用的包名
		String baseModelPackageName = "com.xxx.market.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = rootPath + "/src/main/java/com/xxx/market/model/base";
		
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.xxx.market.model";
		// model 文件保存路径 (MappingKit 与 DataDictionary 文件默认保存路径)
		String modelOutputDir = rootPath + "/src/main/java/com/xxx/market/model";
